      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Dziękujemy za zamówienie. Twoje świeże składniki są już
            przygotowywane.
          </p>
        </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  W panelu klienta możesz śledzić aktualny status przygotowania
                  i dostawy.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Wraz z dostawą otrzymasz szczegółowe przepisy i instrukcje
                  przygotowania.
                </p>
              </div>
            </div>
