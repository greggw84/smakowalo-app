...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "Akceptujemy karty kredytowe i debetowe (VISA, Mastercard), płatność BLIK oraz przelewy bankowe. Płatność jest pobierana po potwierdzeniu zamówienia.",
  ...
  },
  {
    ...
    answer:
      "Tak, wszystkie nasze składniki są świeże i najwyższej jakości. Współpracujemy z lokalnymi dostawcami, aby zapewnić najlepsze produkty sezonowe.",
  ...
  },
  {
    ...
    answer:
      "Większość naszych przepisów została zaprojektowana tak, aby przygotowanie posiłku zajęło nie więcej niż 30 minut. Każdy przepis zawiera szacowany czas przygotowania.",
  ...
  },
  {
    ...
    answer:
      "Tak! Oferujemy 8 różnych opcji dietetycznych: wegetariańską, wegańską, keto, wysokobiałkową, niskokaloryczną, bezglutenową, pescetariańską i paleo.",
    icon: <Settings className="w-5 h-5" />,
  },
];
