...
async function handlePaymentSucceeded(invoice: Stripe.Invoice, supabase: any) {
  ...
  // You could create a payment history record here
  // For now, just log it
  console.log('Payment amount:', invoice.amount_paid / 100, 'PLN')
}
...
async function handlePaymentFailed(invoice: Stripe.Invoice, supabase: any) {
  ...
  console.log('Payment attempt failed:', invoice.amount_due / 100, 'PLN')
}
