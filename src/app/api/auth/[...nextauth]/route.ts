      ...
      async authorize(credentials) {
        ...
        if (supabase) {
          try {
            ...
            // IMPORTANT: Check if email is verified (only in production)
            const isDevelopment = process.env.NODE_ENV === 'development'
            ...
            console.log('✅ Login successful:', credentials.email, 'Email verified:', !!data.user.email_confirmed_at)
            ...
            // Re-throw specific errors so they can be caught by the login page
