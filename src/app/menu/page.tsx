            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm text-green-700">
                  <strong>Produkty ze sklepu:</strong> Wyświetlamy {products.length} produktów z{' '}
                  <a href="https://shop.smakowalo.pl" target="_blank" rel="noopener noreferrer" className="underline font-semibold">
                    shop.smakowalo.pl
                  </a>
                </p>
              </div>
