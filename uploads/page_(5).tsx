...
// Stripe Price IDs mapping for subscription variants
const PRICE_IDS: Record<string, string> = {
  '2-2': process.env.NEXT_PUBLIC_STRIPE_PRICE_2_2 || 'price_1SVD45ChaDkFJkJI2DkNEpkK',
  '2-3': process.env.NEXT_PUBLIC_STRIPE_PRICE_2_3 || 'price_1SVWHUChaDkFJkJIAEZbXXei',
  '2-4': process.env.NEXT_PUBLIC_STRIPE_PRICE_2_4 || 'price_1SVD45ChaDkFJkJI8OP7MDB3',
  '2-5': process.env.NEXT_PUBLIC_STRIPE_PRICE_2_5 || 'price_1SVD45ChaDkFJkJIzdO9CUAI',
  '3-2': process.env.NEXT_PUBLIC_STRIPE_PRICE_3_2 || 'price_1SVD45ChaDkFJkJIwhAc79kF',
  '3-3': process.env.NEXT_PUBLIC_STRIPE_PRICE_3_3 || 'price_1SVD45ChaDkFJkJIavPtADkM',
  '3-4': process.env.NEXT_PUBLIC_STRIPE_PRICE_3_4 || 'price_1SVD45ChaDkFJkJIQD8WJShG',
  '3-5': process.env.NEXT_PUBLIC_STRIPE_PRICE_3_5 || 'price_1SVD45ChaDkFJkJIdMvMGP4O',
  '4-2': process.env.NEXT_PUBLIC_STRIPE_PRICE_4_2 || 'price_1SVD45ChaDkFJkJIKS1x4fwL',
  '4-3': process.env.NEXT_PUBLIC_STRIPE_PRICE_4_3 || 'price_1SVD45ChaDkFJkJIsmkCYQvL',
  '4-4': process.env.NEXT_PUBLIC_STRIPE_PRICE_4_4 || 'price_1SVD45ChaDkFJkJIgwyRP3da',
  '4-5': process.env.NEXT_PUBLIC_STRIPE_PRICE_4_5 || 'price_1SVD45ChaDkFJkJIH0Rw81fj',
};
...
function KreatorPageComponent() {
      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-stretch md:items-center gap-3 pt-6">
        ...
        <Button
          ...
          onClick={() => {
            ...
            // Always go to meal selection (step 4)
            setStep(4)
          }}
    ...
    return (
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Wybierz Swoje Dania</h2>
              ...
              return (
                <Card
                  ...
                  className={`cursor-pointer transition-all hover:shadow-lg ${
                    isSelected ? 'ring-2 ring-[var(--smakowalo-green-primary)]' : ''
                  }`}
                  onClick={() => toggleDish(product)}
                >
        ...
        <div className="flex justify-between">
          ...
          <Button
            onClick={() => setStep(5)}
            size="lg"
            className="bg-[var(--smakowalo-green-primary)] hover:bg-[var(--smakowalo-green-secondary)]"
          >
            Kontynuuj
          </Button>
        </div>
  ...
  const renderStep5Register = () => {
    // If user is already logged in, show a continue button
    if (session?.user) {
      return (
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-8">Jesteś zalogowany!</h1>
          <p className="text-lg text-gray-600 mb-12">
            Witaj {session.user.email}! Możesz kontynuować do następnego kroku.
          </p>
